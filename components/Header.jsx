        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
          ...
          <div className="hidden lg:block">
            <form onSubmit={handleSearchSubmit}>
              <div className="flex align-items-center justify-content-center">
                ...
                <input
                  className="flex h-10 w-[250px] bg-gray-100 px-3 py-2 text-sm placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                  type="text"
          ...
          <div className="">
            ...
            <Menu as="div" className="relative inline-block text-left">
              <div>
                <LanguageSwitcher />
                {/* <Menu.Button className="inline-flex w-full justify-center gap-x-1 rounded-md text-sm m-3 font-bold text-gray-800 hover:text-gray-900">
                                    For you
                                    <ChevronDownIcon className="-mr-1 h-5 w-5 text-gray-400" aria-hidden="true" />
                                </Menu.Button> */}
              </div>
