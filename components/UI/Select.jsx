export default function Select({ id, label, options, size = 'default', ...props }) {
  return (
    <div className="">
      ...
      <select
        id={id}
        className={`w-full  abo p-2 mb-6 text-gray border border-[#6043ba]-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-white dark:border-[#6043ba] dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 ${
